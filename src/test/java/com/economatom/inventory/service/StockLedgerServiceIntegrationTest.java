...
class StockLedgerServiceIntegrationTest {
    ...
    void testRecordStockMovement_ChainMultipleTransactions() {
        ...
        StockLedger tx1 = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("10.0"), MovementType.ENTRADA, "TX1", testUser, null);

        StockLedger tx2 = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("-5.0"), MovementType.SALIDA, "TX2", testUser, null);

        StockLedger tx3 = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("15.0"), MovementType.ENTRADA, "TX3", testUser, null);
    ...
    void testVerifyChainIntegrity_ValidChain() {
        ...
        StockLedgerService.IntegrityCheckResult result = stockLedgerService.verifyChainIntegrity(testProduct.getId());
    ...
    void testVerifyChainIntegrity_DetectsStockCorruption() {
        ...
        StockLedger tx1 = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("50.0"), MovementType.ENTRADA, "TX1", testUser, null);

        StockLedger tx2 = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("30.0"), MovementType.ENTRADA, "TX2", testUser, null);
    ...
    void testVerifyChainIntegrity_DetectsQuantityCorruption() {
        ...
        StockLedger tx1 = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("20.0"), MovementType.ENTRADA, "TX1", testUser, null);
    ...
    void testVerifyChainIntegrity_DetectsBrokenChain() {
        ...
        StockLedger tx2 = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("10.0"), MovementType.ENTRADA, "TX2", testUser, null);
    ...
    void testVerifyChainIntegrity_DetectsDeletedTransaction() {
        ...
        StockLedger tx3 = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("10.0"), MovementType.ENTRADA, "TX3", testUser, null);
    ...
    void testGetProductHistory() {
        ...
        stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("10.0"), MovementType.ENTRADA, "Compra 1", testUser, 1);
        stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("-5.0"), MovementType.SALIDA, "Venta 1", testUser, 2);
        stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("20.0"), MovementType.ENTRADA, "Compra 2", testUser, 3);
    ...
    void testGetCurrentStock() {
        ...
        stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("75.0"), MovementType.ENTRADA, "Test", testUser, null);
    ...
    void testVerifyAllChains() {
        ...
        stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("10.0"), MovementType.ENTRADA, "P1-TX1", testUser, null);
        stockLedgerService.recordStockMovement(
                product2.getId(), new BigDecimal("20.0"), MovementType.ENTRADA, "P2-TX1", testUser, null);
    ...
    void testHashCalculation_Consistency() {
        ...
        StockLedger tx1 = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("10.0"), MovementType.ENTRADA, "Test", testUser, null);
    ...
    void testVerifyChainIntegrity_UpdatesVerificationStatus() {
        ...
        stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("25.0"), MovementType.ENTRADA, "Test", testUser, null);
    ...
    void testResetProductLedger() {
        ...
        stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("30.0"), MovementType.ENTRADA, "TX2", testUser, null);
        stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("-20.0"), MovementType.SALIDA, "TX3", testUser, null);
    ...
    void testResetProductLedger_AllowsNewTransactions() {
        ...
        stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("100.0"), MovementType.ENTRADA, "Old TX", testUser, null);

        stockLedgerService.resetProductLedger(testProduct.getId());

        StockLedger newTx = stockLedgerService.recordStockMovement(
                testProduct.getId(), new BigDecimal("50.0"), MovementType.ENTRADA, "New TX", testUser, null);
